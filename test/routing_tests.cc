...
TEST(routing, island) {
  ...
  EXPECT_EQ(
      ...
      extract_and_route("test/data/luisenplatz-darmstadt.osm.pbf", from, to));
}
...
//       extract_and_route("test/data/ajaccio-ferry.osm.pbf", from, to));
// }
//
// TEST(routing, corridor) {
//   auto const from =
//       osr::location{51.54663831994142, -0.05622849779558692,
//       osr::level_t{0.F}};
//   auto const to =
//       osr::location{51.547004658329, -0.05694437499428773,
//       osr::level_t{0.F}};
//   EXPECT_EQ(
...
//       extract_and_route("test/data/london-corridor.osm.pbf", from, to));
// }
//
// TEST(routing, stop_area) {
//   auto const from =
//       osr::location{48.725296645530705, 2.2612587304760723,
//       osr::level_t{0.F}};
//   auto const to =
...
//       extract_and_route("test/data/station-border.osm.pbf", from, to));
// }
